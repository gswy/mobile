...
/// 处理审核
class TeamHandPage extends GetView<BindCtrl> {
  const TeamHandPage({super.key});
      ...
      children: [
          ...
          children: [
            Expanded(
              child: SizedBox(
                ...
                child: OutlinedButton(
                  onPressed: controller.teamReject,
            ...
            Expanded(
              child: SizedBox(
                height: 44,
                child: OutlinedButton(
                  onPressed: controller.teamAccess,
                  child: Text('申请通过'),
                ),
              ),
            ),
        ...
        Expanded(
          child: SizedBox(
            height: 44,
            child: OutlinedButton(
              onPressed: controller.teamIgnore,
              style: OutlinedButton.styleFrom(
                foregroundColor: scheme.error,
                side: BorderSide(color: scheme.error),
              ),
