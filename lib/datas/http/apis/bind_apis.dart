...
class BindApis {
  ...
  /// 申请添加
  static Future<bool> bindUser(int id, String remark) async {
    try {
  ...
  /// 申请添加
  static Future<bool> bindTeam(int id, String remark) async {
    try {
